<template>
  <b-container fluid class="text-center my-3 py-2">
    <h1 class="homeTitles">About Us</h1>
    <b-row>
      <b-col>
        <p>
          ...
          commercials with great craftsmanship and service at the modest cost. 4
          decades of experience, skill and commitment will surpass your
          expectation.
        </p>
        <p>
          Paint Magics is a team of professional, energetic individuals who
          understand to deliver the same level of customer expectation that the
          family had been exceeding over the years. Every Project is a
